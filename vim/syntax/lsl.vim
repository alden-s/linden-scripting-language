...
syn match lslUUID4 display
\ '"\x\{8}-\x\{4}-[4]\x\{3}-[89abAB]\x\{3}-\x\{12}"'

syn match lslUUID display
...
\ start='\/\/' end='$' contains=lslCommentMulti,lslCommentTodo,@Spell

syn match lslCommentMulti display
\ start='\/\*' end='\*\/' contains=lslComment,lslCommentTodo,@Spell

syn keyword lslCommentTodo contained display
\ BUG Bug FIXME Fixme TEST TODO Test Todo XXX Xxx bug fixme test todo xxx
...
highlight default link lslEvent         Statement
...
highlight default link lslVectorRot     Special
highlight default link lslProperty      Identifier
highlight default link lslString        String
highlight default link lslStringEscape  SpecialChar
highlight default link lslUUID4         Special
highlight default link lslUUID          Special
highlight default link lslBlock         Special
highlight default link lslParen         Special
highlight default link lslList          Special
highlight default link lslTypecast      Operator
highlight default link lslComment       Comment
highlight default link lslCommentMulti  Comment
highlight default link lslCommentTodo   Todo
highlight default link lslInvalid       Error
